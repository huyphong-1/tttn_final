...
const TOP_RATED_SORTS = [
  { value: "rating_desc", label: "Danh gia cao nhat", orderBy: "rating", ascending: false },
  ...SORT_OPTIONS,
];
...
export default function TopRatedPage() {
  ...
  const [sort, setSort] = useState(TOP_RATED_SORTS[0].value);
  ...
  const sortConfig = useMemo(() => getSortConfig(TOP_RATED_SORTS, sort), [sort]);
  ...
  return (
    <main className="max-w-6xl mx-auto px-4 pt-10 pb-14">
      ...
      <OptimizedFilterBar
        ...
        priceHint="VD: 6000000 - 25000000"
        sort={sort}
        onSortChange={setSort}
        sortOptions={TOP_RATED_SORTS}
      ...
      {showEmpty && (
        <p className="text-sm text-slate-400 mb-4">
          {isFiltering ? "Khong co san pham trong bo loc nay." : "Chua co san pham top-rated trong co so du lieu."}
        </p>
      )}
